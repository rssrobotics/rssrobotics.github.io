...
python3 _data/scripts/papers.py raw_papers.txt _data/conference_program.csv _data/papers.csv _program/papers --submdir _papers
"""
...
def main():
    ...
    with open(args.csv_outfile, 'w') as f:
        writer = csv.DictWriter(f, fieldnames=[
            'talk_id', 'external_id', 'internal_id',
